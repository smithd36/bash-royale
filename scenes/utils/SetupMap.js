...
export function setupMap() {
  ...
  const tower = map.addTilesetImage('brick_house_2', 'tower');
  const flags = map.addTilesetImage('flags', 'flags');

  const bgLayer = map.createLayer('tiles', [tiles, hex_sheet, brown_tree, tower, flags], 0, 0);
  const object1 = map.createLayer('object1', [tiles, hex_sheet, brown_tree, tower, flags], 0, 0);
